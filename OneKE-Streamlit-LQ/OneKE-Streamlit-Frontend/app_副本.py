...
examples = [
    ...
    },
    {
        ...
        "mode": "quick",
        "use_file": True,
        "file_path": "../OneKE/data/input_files/Artificial_Intelligence_Wikipedia.txt",
        "instruction": "",
    ...
    },
    {
        ...
        "mode": "quick",
        "use_file": True,
        "file_path": "../OneKE/data/input_files/Harry_Potter_Chapter1.pdf",
    ...
    },
    {
        ...
        "mode": "quick",
        "use_file": True,
        "file_path": "../OneKE/data/input_files/Tulsi_Gabbard_News.html",
...
def start_with_example():
    ...
    if example_index == 0:
        with open("../OneKE/data/input_files/ChineseNewsExample.json", "r", encoding="utf-8") as file:
